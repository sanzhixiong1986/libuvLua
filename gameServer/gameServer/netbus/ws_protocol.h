...
public:
	...
	static bool read_ws_header(unsigned char* pkg_data, int pak_len, int* pkg_size, int* out_header_size);
	static void parser_ws_recv_data(unsigned char* rew_data, unsigned char* mask, int rew_len);
